...
stab_explainer.gstab_lm <- function(object) {
  ...
  stability_definitions <- list(
    "Replication Stability" = list(
      definition = "If a new data set is sampled and apply the same technique to this new set, then the results should not change dramatically.",
    ...
    "Statistical Stability" = list(
      definition = "It refers to the stability of the analysis whenever no new data set is formally sampled.",
    ...
    "Stability under Data Selection" = list(
      definition = "Variations in the data are considered, by omitting either objects from the data set or variables from subsequent analysis.",
    ...
    "Stability under Model Selection" = list(
      definition = "Small changes in the model should result in small changes in the results obtained.",
    ...
    "Numerical Stability" = list(
      definition = "It refers to the influence of rounding errors and of computation with limited precision on the results given by the techniques.",
    ...
    "Analytic and Algebraic Stability" = list(
      definition = "If the data structures and possible representations have enough mathematical structure, then formal expressions of the input-output analysis can be drawn from considering perturbations of the input.",
    ...
    "Stability under Selection of Technique" = list(
      definition = "Application of a number of different techniques to the same data set, aiming at answering the same question, results in approximately the same information.",
